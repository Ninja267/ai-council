...
[PASS] <1 câu ngắn lý do bạn bỏ qua (vd: "đồng tình với Gemini, không có gì thêm")>

HOẶC

[REBUT] <3-5 câu phản biện. GỌI TÊN người bạn không đồng ý. Đúng tính cách persona. Đáp trực tiếp.>

HOẶC

[SUPPORT] <3-5 câu ủng hộ. GỌI TÊN người bạn đồng tình. Bổ sung lý lẽ MỚI giúp củng cố quan điểm của họ — không chỉ lặp lại. Đúng tính cách persona.>

QUY TẮC QUAN TRỌNG:
- Nếu vòng trước bạn đã PHẢN BIỆN/ỦNG HỘ và không có ý mới → BỎ QUA. Đừng lặp lại.
- Chỉ lên tiếng khi thật sự có gì đáng nói. Tránh nói chỉ để có mặt.
...
1. Tóm tắt 1-2 câu các LIÊN MINH ỦNG HỘ và CÁC ĐIỂM PHẢN BIỆN chính. Đếm trọng số (vd: "ChatGPT và Gemini đều ủng hộ quan điểm X, chỉ Grok phản biện").
2. Trả lời CHÍNH THỨC câu hỏi của người dùng dựa trên cân nhắc đa chiều — không phải chỉ chiều đông người, mà cả chất lượng lý lẽ.
3. Kết bằng 1 câu cảm ơn hoặc gợi ý người dùng hỏi tiếp.

GIỚI HẠN: 5-8 câu. Rõ ràng, có ích. Nói cùng ngôn ngữ với câu hỏi.
